  ...
  children: [
    ...
    { key: "attendance", label: "Pointage", icon: "ClipboardCheck", permission: "attendance.view", pageType: "group",
      children: [
        ...
        { key: "attendance-sickness", label: "Maladie", route: "/rh/pointage/maladie", permission: "attendance.view", pageType: "workflow", status: "ready", component: "HrRequestWorkflow",
          elements: ["Déclaration de la maladie", "Pièces justificatives"] },
        { key: "attendance-accident", label: "Accident", route: "/rh/pointage/accident", permission: "attendance.view", pageType: "workflow", status: "ready", component: "HrRequestWorkflow",
          elements: ["Déclaration de l'accident", "Pièces justificatives"] },
        { key: "attendance-permissions", label: "Permissions", route: "/rh/pointage/permissions", permission: "attendance.view", pageType: "workflow", status: "ready", component: "HrRequestWorkflow",
          elements: ["Demande", "Étude de la demande", "Pièces justificatives"] },
        { key: "attendance-travel", label: "Déplacement professionnel", route: "/rh/pointage/deplacements", permission: "attendance.view", pageType: "workflow", status: "ready", component: "HrRequestWorkflow",
          elements: ["Demande", "Étude de la demande", "Pièces justificatives"] },
        { key: "attendance-mission", label: "Mission", route: "/rh/pointage/missions", permission: "attendance.view", pageType: "workflow", status: "ready", component: "HrRequestWorkflow",
          elements: ["Demande", "Étude de la demande", "Pièces justificatives"] },
      ] },
