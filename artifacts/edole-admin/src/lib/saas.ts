...
export const ROUTE_MODULE_MAP: Array<{ test: (path: string) => boolean; moduleKey: string }> = [
  ...
  { test: (p) => p.startsWith("/logistique"), moduleKey: "operations" },
  { test: (p) => p.startsWith("/equipements"), moduleKey: "inventory_assets" },
  { test: (p) => p.startsWith("/stock"), moduleKey: "inventory_products" },
  { test: (p) => p.startsWith("/locations") || p.startsWith("/inspections"), moduleKey: "rentals" },
  ...
  { test: (p) => p.startsWith("/admin") || p.startsWith("/utilisateurs"), moduleKey: "administration" },
  { test: (p) => p.startsWith("/abonnement"), moduleKey: "billing_subscription" },
  { test: (p) => p.startsWith("/workspace-settings") || p.startsWith("/parametres"), moduleKey: "workspace_settings" },
];
