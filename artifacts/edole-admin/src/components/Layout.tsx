...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Factures fournisseurs", path: "/achats/factures",         icon: FileText,        moduleKey: "purchases", permissionKey: "purchases.read",    description: "Enregistrez et contrôlez les factures reçues avant leur paiement." },
