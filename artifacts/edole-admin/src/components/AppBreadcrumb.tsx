...
const ROUTES: Array<{ pattern: RegExp; crumbs: Crumb[] }> = [
  ...
  // ── Collaborators ──────────────────────────────────────────────
  { pattern: /^\/collaborateurs\/[^/?]+/, crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Fiche collaborateur" }] },
  { pattern: /^\/collaborateurs$/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Collaborateurs" }] },
  ...
  // ── RH ─────────────────────────────────────────────────────────
  { pattern: /^\/rh\/departements/,       crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Départements" }] },
  { pattern: /^\/rh\/postes/,             crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Postes" }] },
  { pattern: /^\/rh\/contrats/,           crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Contrats" }] },
  { pattern: /^\/rh\/documents/,          crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Documents" }] },
  { pattern: /^\/rh\/affectations/,       crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Affectations" }] },
  { pattern: /^\/rh\/conges/,             crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Congés" }] },
  { pattern: /^\/rh\/paie/,               crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Paie" }] },
  { pattern: /^\/rh\/recrutement/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Recrutement" }] },
  { pattern: /^\/rh\/evaluations/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Évaluations" }] },
  { pattern: /^\/rh\/formations/,         crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Formations" }] },
  { pattern: /^\/rh\/mouvements/,         crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Mouvements" }] },
  { pattern: /^\/rh\/organigramme/,       crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Organigramme" }] },
  { pattern: /^\/rh\/intelligence/,       crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Intelligence" }] },
  { pattern: /^\/rh\/notes-frais/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Notes de frais" }] },
  { pattern: /^\/rh\/integration/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Intégration" }] },
  { pattern: /^\/rh\/avantages/,          crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Avantages" }] },
  { pattern: /^\/rh\/registre-legal/,     crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Registre légal" }] },
  { pattern: /^\/rh\/indicateurs/,        crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Indicateurs" }] },
  { pattern: /^\/rh\/rapports/,           crumbs: [{ label: "Accueil", href: "/" }, { label: "Ressources Humaines", href: "/rh" }, { label: "Rapports RH" }] },
