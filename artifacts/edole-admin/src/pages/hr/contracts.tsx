...
export default function ContractsPage() {
  ...
  const statusBadge = (s: string) => {
    const map: Record<string, string> = { active: "bg-emerald-100 text-emerald-700", terminated: "bg-slate-200 text-foreground", suspended: "bg-amber-100 text-amber-700", expired: "bg-red-100 text-red-700", draft: "bg-blue-100 text-blue-700" };
