...
export default function EntriesPage() {
  ...
  return (
    <AccountingShell
      ...
      actions={<Button onClick={() => setOpen(true)} className=""><Plus className="w-4 h-4 mr-2" />Saisir une écriture</Button>}
    >
      <Card className="mb-4">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-3xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={() => create.mutate()} disabled={!balanced || create.isPending} className="">Enregistrer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
