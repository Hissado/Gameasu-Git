...
export default function FixedAssetsPage() {
  ...
  return (
    <AccountingShell
      ...
      actions={<Button onClick={() => setOpen(true)} className="bg-orange-600 hover:bg-orange-700"><Plus className="w-4 h-4 mr-2" />Nouvelle immobilisation</Button>}
    >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={() => create.mutate()} disabled={!form.code || !form.label || !form.acquisitionCost || !form.accountId || create.isPending} className="bg-orange-600 hover:bg-orange-700">Créer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </AccountingShell>
