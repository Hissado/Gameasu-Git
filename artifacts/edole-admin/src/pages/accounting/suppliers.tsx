  ...
  return (
    <AccountingShell
      ...
      actions={<>
        ...
        <Button onClick={() => setOpenInv(true)} className="bg-primary hover:bg-primary/90"><Receipt className="w-4 h-4 mr-2" />Saisir facture</Button>
      </>}
    >
      ...
      <Dialog open={openSupplier} onOpenChange={setOpenSupplier}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createSupplier.mutate()} disabled={!supplierForm.name || createSupplier.isPending} className="bg-primary hover:bg-primary/90">Créer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={openInv} onOpenChange={setOpenInv}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createInv.mutate()} disabled={!invForm.supplierId || !invForm.totalAmount || createInv.isPending} className="bg-primary hover:bg-primary/90">Enregistrer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!openPayment} onOpenChange={() => setOpenPayment(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createPayment.mutate()} disabled={!paymentForm.amount || createPayment.isPending} className="bg-primary hover:bg-primary/90">Régler</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </AccountingShell>
