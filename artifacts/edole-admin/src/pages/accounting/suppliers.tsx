  ...
  return (
    <AccountingShell
      ...
      actions={<>
        ...
        <Button onClick={() => setOpenInv(true)} className="bg-orange-600 hover:bg-orange-700"><Receipt className="w-4 h-4 mr-2" />Saisir facture</Button>
      </>}
    >
      ...
      <Dialog open={openSupplier} onOpenChange={setOpenSupplier}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createSupplier.mutate()} disabled={!supplierForm.name || createSupplier.isPending} className="bg-orange-600 hover:bg-orange-700">Créer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={openInv} onOpenChange={setOpenInv}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createInv.mutate()} disabled={!invForm.supplierId || !invForm.totalAmount || createInv.isPending} className="bg-orange-600 hover:bg-orange-700">Enregistrer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!openPayment} onOpenChange={() => setOpenPayment(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createPayment.mutate()} disabled={!paymentForm.amount || createPayment.isPending} className="bg-orange-600 hover:bg-orange-700">Régler</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </AccountingShell>
