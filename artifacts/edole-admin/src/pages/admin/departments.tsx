                  ...
                  <TableRow key={d.id}>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: d.color || "#2563EB22" }}>
                          <Building2 className="w-4 h-4" style={{ color: d.color || "#2563EB" }} />
                        </div>
