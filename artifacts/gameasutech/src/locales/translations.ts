export const translations = {
  fr: {
    ...
    services: {
      ...
      s4: { title: "Cybersécurité", desc: "Audit sécurité, protection, gestion risques, surveillance, données" },
      s5: { title: "Sécurité Physique & Technologies", desc: "Contrôle d'accès, vidéosurveillance, bâtiments connectés" },
      s6: { title: "Intelligence Artificielle", desc: "Automatisation intelligente, assistants IA, analyse données" },
      s7: { title: "Services IT Managés", desc: "Support, maintenance, supervision, assistance, gestion proactive" },
      s8: { title: "Services Professionnels", desc: "Conseil IT, déploiement, gestion projets, formation, accompagnement" },
  ...
  en: {
    ...
    services: {
      ...
      s4: { title: "Cybersecurity", desc: "Security audit, protection, risk management, monitoring, data" },
      s5: { title: "Physical Security & Connected Tech", desc: "Access control, video surveillance, smart buildings" },
      s6: { title: "AI & Automation", desc: "Intelligent automation, AI assistants, data analysis" },
      s7: { title: "Managed IT Services", desc: "Support, maintenance, supervision, assistance, proactive management" },
      s8: { title: "Professional Services", desc: "IT consulting, deployment, project management, training, support" },
