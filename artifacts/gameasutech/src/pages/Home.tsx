      ...
      <section className="py-28 bg-white border-t border-slate-100">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { ...resources[0], img: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=500&q=70&auto=format&fit=crop" },
              { ...resources[1], img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=500&q=70&auto=format&fit=crop" },
              { ...resources[2], img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=500&q=70&auto=format&fit=crop" },
            ].map((r, i) => (
              <motion.div key={i} custom={i} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <Link href={r.href}>
