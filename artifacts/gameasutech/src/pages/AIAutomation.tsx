...
export default function AIAutomation() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <section className="relative pt-24 pb-12 bg-gradient-to-br from-slate-50 via-violet-50/20 to-white overflow-hidden">
      ...
      <section className="py-12 bg-white border-y border-slate-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {results.map((r, i) => (
              <motion.div key={i} initial={{ y: 16 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ delay: i * 0.03 }} className="text-center p-6 bg-slate-50 rounded-xl border border-slate-100">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-violet-50/10 border-y border-slate-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
