    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-24 pb-12 bg-gradient-to-br from-slate-50 via-blue-50/30 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div initial={{ y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }} className="max-w-4xl">
      ...
      <section className="py-12 md:py-20 bg-white border-y border-slate-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <motion.div initial={{ y: 20 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0.05 }} className="bg-primary/5 border border-primary/15 rounded-2xl p-6 md:p-10">
            ...
            <motion.div initial={{ y: 20 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ delay: 0.1 }} className="bg-white border border-slate-200 rounded-2xl p-6 md:p-10 hover:border-primary/30 transition-colors shadow-sm">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                {milestones.map((m, i) => (
                  <motion.div key={i} initial={{ x: -20 }} whileInView={{ x: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ delay: i * 0.03 }} className="flex gap-8 relative">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-start mb-10 md:mb-14">
            ...
            <div className="grid grid-cols-1 gap-3">
              {commitments.map((c, i) => (
                <motion.div key={i} initial={{ x: 20 }} whileInView={{ x: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ delay: i * 0.025 }} className="flex items-start gap-4 p-4 rounded-xl bg-white border border-slate-200 hover:border-primary/30 transition-colors shadow-sm">
          ...
          {/* Commitment banner */}
          <motion.div initial={{ y: 24 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.28 }}>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <motion.div initial={{ x: -30 }} whileInView={{ x: 0 }} viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.28 }}>
              <p className="text-primary font-semibold uppercase tracking-widest text-sm mb-4">
