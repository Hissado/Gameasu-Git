  ...
  try {
    ...
    if (aiAvailable()) {
      narrative = await summarize({
        system: "Tu es le briefer exécutif Gameasu. Rédige un briefing matinal de 4-6 phrases, en français business, pour un dirigeant pressé. Hiérarchise : priorités du jour > alertes argent > risques > opportunités. Pas de markdown, pas de préambule. Sois factuel.",
