...
export const SYSTEM_ROLES: RoleSeed[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "commercial.read",
      "equipment.read",
      "accounting.read", "accounting.manage", "accounting.manage_chart", "accounting.approve_entries", "accounting.manage_banks", "accounting.export",
  ...
  },
  {
    ...
    permissions: [
      ...
      "equipment.read",
      "accounting.read", "accounting.manage", "accounting.manage_chart", "accounting.approve_entries", "accounting.manage_banks", "accounting.export", "accounting.view_sensitive",
      "fpa.read", "fpa.manage", "fpa.approve", "fpa.export",
      "documents.read", "documents.manage",
      "messaging.use",
      "purchases.read", "purchases.write", "purchases.approve", "purchases.pay", "purchases.export",
