...
<div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08)">
  <div style="background:#0b0b0b;padding:20px 28px"><div style="color:#FF6B00;font-weight:700;letter-spacing:2px;font-size:11px;margin-bottom:4px">GAMÉASÙ RH</div><h1 style="margin:0;font-size:18px;color:#fff">Alerte — Déclarations fiscales en attente</h1></div>
